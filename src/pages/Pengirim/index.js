...
// const Pengirim = ({navigation}) => {
//   return (
//     <View>
//       <Text
//         onPress={() =>
//           navigation.navigate('Penerima', {itemId: 9, otherParam: 'test data'})
//         }>
//         Halaman Pengirim
//       </Text>
//     </View>
...
const Item = ({name, email, bidang, onPress, onDelete, gambar, onSend}) => {
  return (
    <View style={styles.itemContainer}>
      ...
      <View style={styles.desc}>
        <Text style={styles.descNama} onPress={onSend}>
          {name}
        </Text>
...
const Pengirim = ({navigation}) => {
  ...
  const getData = () => {
    axios.get('https://griyamu.com/mesin/aw/').then((res) => {
  ...
  const sendItem = (itemgf) => {
    const aksjfh = itemgf.ID;
